// used to listen for scans and return all ports as open

// filters on SYN packets destined for closed ports
// callback function spoofs a legitimate looking SYN/ACK response to any SYN packet that makes it through the BPF

// gcc $(libnet-config --defines) shroud.c -o shroud -lnet -lpcap
